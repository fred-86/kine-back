...
{
    /**
     * @Route("/", name="app_back_status_index", methods={"GET"})
     */
    ...
    /**
     * @Route("/new", name="app_back_status_new", methods={"GET", "POST"})
     */
    public function new(Request $request, StatusRepository $statusRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_back_status_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    /**
     * @Route("/{id}", name="app_back_status_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{id}/edit", name="app_back_status_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{id}", name="app_back_status_delete", methods={"POST"})
     */
